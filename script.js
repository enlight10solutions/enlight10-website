document.addEventListener("DOMContentLoaded", function () {
  ...
  if (headerMount) {
    ...
    headerMount.outerHTML = [
      ...
      '      <a href="./watchman.html"' + currentAttr(["watchman"], current) + '>Watchman™</a>',
      '      <div class="dropdown">',
      '        <button class="dropdown-toggle" type="button" aria-haspopup="true" aria-expanded="false">Services ▾</button>',
      '        <div class="dropdown-panel">',
      '          <a href="./services-secureops.html"' + currentAttr(["services-secureops"], current) + '>enLight10 SecureOps™<span class="sub">Managed cyber operations</span></a>',
      '          <a href="./services-cyber-defense-united.html"' + currentAttr(["services-cyber-defense-united"], current) + '>enLight10 Cyber Defense United™<span class="sub">DoD and DIB mission services</span></a>',
      ...
      '        </div>',
      '      </div>',
      '      <a class="nav-pilot" href="mailto:info@enlight10solutions.com?subject=Watchtower%E2%84%A2%20Pilot%20Request&amp;body=Organization%3A%0AEnvironment%3A%0ACurrent%20security%20tools%3A%0APilot%20goal%3A%0ATimeline%3A">Start a Pilot</a>',
      '    </div>',
      ...
      '    <a href="./services-secureops.html"' + currentAttr(["services-secureops"], current) + '>enLight10 SecureOps™</a>',
      '    <a href="./services-cyber-defense-united.html"' + currentAttr(["services-cyber-defense-united"], current) + '>enLight10 Cyber Defense United™</a>',
      ...
      '    <a class="button small" href="mailto:info@enlight10solutions.com?subject=Watchtower%E2%84%A2%20Pilot%20Request">Start a Pilot</a>',
      '  </nav>',
      '</aside>'
    ].join("\n");
  }
  ...
  if (footerMount) {
    footerMount.outerHTML = [
      ...
      '        <a href="./watchman.html">Watchman™</a>',
      '        <a href="./watchtower.html#full-demo">Product Demo</a>',
      '        <a href="mailto:info@enlight10solutions.com?subject=Watchtower%E2%84%A2%20Pilot%20Request">Start a Pilot</a>',
      '      </div>',
      '      <div class="footer-column">',
      '        <h2>Services</h2>',
      '        <a href="./services-secureops.html">enLight10 SecureOps™</a>',
      '        <a href="./services-cyber-defense-united.html">enLight10 Cyber Defense United™</a>',
