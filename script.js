document.addEventListener("DOMContentLoaded", function () {
  ...
  if (footerMount) {
    footerMount.outerHTML = [
      ...
      '        <a href="./enLight10_Capability_Statement.pdf">Download Capability Statement (PDF)</a>',
      ...
      '      <div class="footer-social"><a href="https://linkedin.com/company/enlight10solutions" target="_blank" rel="noopener">LinkedIn</a> · <a href="https://x.com/E10Solutions" target="_blank" rel="noopener">X</a> · <a href="https://github.com/enlight10solutions" target="_blank" rel="noopener">GitHub</a></div>',
      '    </div>',
      '  </div>',
      '</footer>'
    ].join("\n");
